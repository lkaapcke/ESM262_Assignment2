...
show_query(class_types)

features <- dbGetQuery(gaz.db, "SELECT COUNTY_NAME AS 'County', count(Class_Type) AS 'Manmade' FROM class_types_db WHERE Class_Type = 'Manmade' AND COUNTY_NAME != 'NA' GROUP BY COUNTY_NAME;")
features

features3 <- dbGetQuery(gaz.db, "SELECT class_types_db.COUNTY_NAME AS 'County', count(class_types_db.Class_Type) AS 'Manmade' FROM class_types_db WHERE class_types_db.Class_Type = 'Manmade' AND class_types_db.COUNTY_NAME != 'NA' GROUP BY class_types_db.COUNTY_NAME
                        JOIN (SELECT count(class_types_db.Class_Type) AS 'Natural' 
                        FROM class_types_db 
                        WHERE class_types_db.Class_Type = 'Natural' 
                        AND class_types_db.COUNTY_NAME != 'NA' 
                        GROUP BY class_types_db.COUNTY_NAME)
                        ON class_types_db.COUNTY_NAME = class_types_db.COUNTY_NAME;")


features3

# I think the way to solve this is with subqueries, but I cannot get it to work.
